...
non-production mock-provider build; the default build registers no provider
or parser release and fails closed before source state or value admission.
*STOP:* this edition therefore does not claim a production provider
authenticator or parser, production price history, fractional-lot bearer
